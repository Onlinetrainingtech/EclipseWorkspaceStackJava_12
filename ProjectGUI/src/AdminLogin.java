...
public class AdminLogin extends JFrame {
	...
	public AdminLogin() {
		...
		lblNewLabel.setBounds(148, 11, 80, 21);
		...
		textField.setBounds(113, 58, 187, 21);
		panel.add(textField);
		...
		textField_1.setBounds(113, 122, 187, 20);
		panel.add(textField_1);
		textField_1.setColumns(10);
		
		JButton btnNewButton = new JButton("Login");
		btnNewButton.setBounds(94, 193, 89, 23);
		panel.add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("Reset");
		btnNewButton_1.setBounds(231, 193, 89, 23);
